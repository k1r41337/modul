...
local PandoruyHub = {}
function PandoruyHub:MakeNotify(NotifyConfig)
    local NotifyConfig = NotifyConfig or {}
    NotifyConfig.Title = NotifyConfig.Title or "PandoruyHub"
    NotifyConfig.Description = NotifyConfig.Description or "Notification"
    NotifyConfig.Content = NotifyConfig.Content or "Content"
    NotifyConfig.Color = NotifyConfig.Color or Color3.fromRGB(255, 165, 0)
...
function gajahNotify(msg, delay, color, title, desc)
    return PandoruyHub:MakeNotify({
        Title = title or "PandoruyHub",
...
function PandoruyHub:Window(GuiConfig)
    ...
    if GuiConfig.Theme then
        ...
        Main.BackgroundTransparency = GuiConfig.BackgroundTransparency or 0.10
    end
    ...
    Fullscreen.Activated:Connect(function()
        ...
        if isFullscreen then
            ...
            ImageLabel3.Image = "rbxassetid://103624489836882" -- square/maximize icon
            isFullscreen = false
        else
    ...
    function GuiFunc:ToggleUI()
        ...
        MainButton.Size = UDim2.new(0, 110, 0, 110)
        ...
        if GuiConfig.Image then
            ...
            MainButton.Image = "rbxassetid://133204178755303"
        end
